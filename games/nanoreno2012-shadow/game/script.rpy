...
label choice4_girl:
    ...
    scene bg bridge2
    $ renpy.pause(2)
    #WEETABIX NOTE: All the $ renpy.pause(0.5) commands that you will find in this game are meant to be 500-millisecond character/scene dissolve commands, but thanks to the LIMITED functon of the current RenPSP this feature cannot be rendered.
    show eve 1b
    $ renpy.pause(0.5)
...
label jacket_scene:        
    scene bg bridge1
    $ renpy.pause(0.5)
    #WEETABIX NOTE: Extra 500-millisecond pause requested by programmer
    $ renpy.pause(0.5)
...
label meeting1_scene:
    play music "Music/Water's Surface.ogg"
    scene bg bridge1
    #WEETABIX NOTE: No fade effects to see here.
    "Ryo halted to a stop when he came to the bridge."
    ...
    $ renpy.pause(0.5)
    e "Why?"
    r "Because you still have not answered my question?"
    show eve 10b
    $ renpy.pause(0.5)
    e "Are you sure?"
    r "Yes."
    ...
    show eve 5b
    $ renpy.pause(0.5)
    #WEETABIX NOTE: Extra 1000-millisecond pause requested by programmer
    $ renpy.pause(1)
    show eve 4
    $ renpy.pause(0.5)
